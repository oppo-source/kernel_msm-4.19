...
struct softiris_color
{
	...
	uint32_t color_softiris_status; //[0:1] [not support:support]
};
...
#define PANEL_IOCTL_SET_APOLLO_BACKLIGHT      PANEL_IOW(0x51, struct backlight_apollo_maplist)
#define PANEL_IOCTL_SET_APOLLO_VBACKLIGHT     PANEL_IOW(0x52, struct backlight_apollo_vmaplist)
