...
{
	INIT_INFO("Support HPB Spec : UFSHPB_VER_2_0_0 = (%.4X)   UFSHPB_VER_2_0_1 = (%.4X)   Device = (%.4X)",
		 UFSHPB_VER_2_0_0, UFSHPB_VER_2_0_1,hpb_dev_info->hpb_ver);

	INIT_INFO("HPB Driver Version : %.4X", UFSHPB_DD_VER);

	if (hpb_dev_info->hpb_ver != UFSHPB_VER_2_0_0 &&
		hpb_dev_info->hpb_ver != UFSHPB_VER_2_0_1) {
