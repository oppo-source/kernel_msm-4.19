	...
	unsigned long event, void *ptr)
{
  ...
  /* WangWeiwei@NETWORK.KERNEL.IPA,2020/09/01,292664 Add for debug modem crash. begain*/
	/*if (atomic_read(&ipa3_ctx->ipa_clk_vote)) {
		...
		ipa_save_registers();
		ipa_wigig_save_regs();
	 /* WangWeiwei@NETWORK.KERNEL.IPA,2020/09/01,292664 Add for debug modem crash. end*/
