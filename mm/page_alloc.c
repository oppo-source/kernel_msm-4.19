...
/*Huacai.Zhou@Tech.Kernel.MM, 2020-03-21, add memory isolate support*/
...
#if defined(OPLUS_FEATURE_MEMORY_ISOLATE) && defined(CONFIG_OPLUS_MEMORY_ISOLATE)
/* Shiming.Zhang@PSW.BSP.Kernel.MM, 2017-11-15
 * could not reserve MIGRATE_OPLUS as MIGRATE_HIGHATOMIC
 */
...
#if defined(OPLUS_FEATURE_MEMORY_ISOLATE) && defined(CONFIG_OPLUS_MEMORY_ISOLATE)
/* Hui.Fan@PSW.BSP.Kernel.MM, 2017-8-21
 * Account free pages for MIGRATE_is_migrate_oplus2
 */
...
#if defined(OPLUS_FEATURE_MEMORY_ISOLATE) && defined(CONFIG_OPLUS_MEMORY_ISOLATE)
/* Hui.Fan@PSW.BSP.Kernel.MM, 2017-8-21
 * Order-2 allocation use MIGRATE_OPLUS first
 */
...
#if defined(OPLUS_FEATURE_MEMORY_ISOLATE) && defined(CONFIG_OPLUS_MEMORY_ISOLATE)
/* Hui.Fan@PSW.BSP.Kernel.MM, 2017-8-21
 * If MIGRATE_OPLUS not empty, return true
 */
...
#if defined(OPLUS_FEATURE_MEMORY_ISOLATE) && defined(CONFIG_OPLUS_MEMORY_ISOLATE)
/* Hui.Fan@PSW.BSP.Kernel.MM, 2017-8-21
 * Setup MIGRATE_OPLUS blocks for each zone
 */
